...
if __name__ == '__main__':
    ...
    for i in range(1):
        ...
        load_path = '../saved_models/ReLU-ImageNet3-1-VGG-16-II.pth'
        ...
        if args.calib == 'light':
            bias_corr_model(model=snn, train_loader=test_loader, correct_mempot=False)
            weights_cali_model(model=snn, train_loader=test_loader, num_cali_samples=512, learning_rate=1e-5)
