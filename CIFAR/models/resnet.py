...
#
#     def __init__(self, block, layers, num_class=10, use_bn=True, freeze_avg=True):
...
#         super(SpikeResModule, self).__init__(sim_length, conv)
#
#     def forward(self, input: torch.Tensor, residual: torch.Tensor):
#
#         return self.fwd_func(input, self.org_weight, self.org_bias, **self.fwd_kwargs) + residual
#
#
# class SpikeBasicBlock(nn.Module):
#     def __init__(self, basic_block: BasicBlock, **spike_params):
