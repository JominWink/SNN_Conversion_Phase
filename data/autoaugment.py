...
class SubPolicy(object):
    ...
    #     img.transform(img.size(), Image.AFFINE, (1, magnitude * random.choice([-1, 1]), 0, 0, 1, 0), Image.BICUBIC, )
    #
    # def shearY(self, img, magnitude):
    #     img.transform(img.size(), Image.AFFINE, (1, 0, 0, magnitude * random.choice([-1, 1]), 1, 0), Image.BICUBIC, fillcolor=self.fillcolor)
    #
    # def translateX(self, img, magnitude):
    #     img.transform(img.size, Image.AFFINE, (1, 0, magnitude * img.size[0] * random.choice([-1, 1]), 0, 1, 0), fillcolor=self.fillcolor)
    #
    # def translateY(self, img, magnitude):
    #     img.transform(img.size, Image.AFFINE, (1, 0, 0, 0, 1, magnitude * img.size[1] * random.choice([-1, 1])), fillcolor=self.fillcolor)
    #
    # def rotate(self, img, magnitude):
    #     self.rotate_with_fill(img, magnitude)
    #
    # def color(self, img, magnitude):
    #     ImageEnhance.Color(img).enhance(1 + magnitude * random.choice([-1, 1]))
    #
    ...
    #     ImageEnhance.Contrast(img).enhance(1 + magnitude * random.choice([-1, 1]))
    #
    # def sharpness(self, img, magnitude):
    #     ImageEnhance.Sharpness(img).enhance(1 + magnitude * random.choice([-1, 1]))
    #
    # def brightness(self, img, magnitude):
    #     ImageEnhance.Brightness(img).enhance(1 + magnitude * random.choice([-1, 1]))
    #
